...
Retrieves selected, essential information about Chile or any other
...
API usage: <https://restcountries.com/v3.1/name/chile?fullText=true>.
...
- name:
  ...
  Full country name (common or official). For example: "Chile", "Peru",
  "France".
