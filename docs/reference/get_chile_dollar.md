...
This function retrieves the observed exchange rate ("Dólar observado")
in Chilean Pesos from the API endpoint: <https://findic.cl/api/dolar>.
The data is provided by the Chilean website
...
The function sends a GET request to the `/api/dolar` endpoint. If the
