...
#'
#' @description
#' Retrieves the list of official public holidays in Chile for a specific year
...
#'
#' @export
get_chile_holidays <- function(year) {
  url <- sprintf("https://date.nager.at/api/v3/PublicHolidays/%s/CL", year)
