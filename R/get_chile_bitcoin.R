...
#'
#' This function retrieves the observed value of Bitcoin in US Dollars
#' from the API endpoint: \url{https://findic.cl/api/bitcoin}. The data is provided by the
...
#'   \item \code{valor}: Valor del bitcoin en dólares estadounidenses (numérico).
#' }
#'
#' @details
#' The function sends a GET request to the \code{/api/bitcoin} endpoint. If the request is successful (HTTP 200),
...
#'
#' @export
get_chile_bitcoin <- function() {
  url <- "https://findic.cl/api/bitcoin"
