...
#'
#' @description
#' Retrieves comprehensive country information for Chile from the REST Countries API.
...
#'
#' @return A tibble with one row containing Chile's country information:
#' \describe{
...
#' for Chile using full text search. It handles API errors gracefully and
...
#'
#' @export
get_country_info_cl <- function() {
  url <- "https://restcountries.com/v3.1/name/chile?fullText=true"
  ...
  if (length(data_list) == 0) {
    message("No data found for Chile.")
    return(NULL)
  }
