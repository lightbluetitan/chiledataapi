...
#'
#' @description
#' Retrieves Chile's adult literacy rate (% of people ages 15 and above)
...
#'
#' @export
get_chile_literacy_rate <- function() {
  url <- "https://api.worldbank.org/v2/country/CHL/indicator/SE.ADT.LITR.ZS?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)
